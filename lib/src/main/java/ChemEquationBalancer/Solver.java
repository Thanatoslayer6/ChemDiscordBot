package ChemEquationBalancer;

import java.util.ArrayList;

// Code is not mine its from -> https://github.com/theRoughCode/Balancer
public class Solver extends decipher {
    private double[][] m;
    ...
    public Solver(String equation) throws Exception {
        super(equation);
    ...
    public String printEquation(boolean subscript) {
        String finalEq = "";
        int i = 0;
